  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      attest: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('attest',
                                     ...
                                     'attestation-vault.compact line 36 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      grantDisclosure: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(payload_hash_0).concat(_descriptor_0.toValue(grantee_0).concat(_descriptor_1.toValue(level_0))),
      ...
      revokeDisclosure: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revokeDisclosure',
                                     'argument 1 (as invoked from Typescript)',
                                     'attestation-vault.compact line 55 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(payload_hash_0.buffer instanceof ArrayBuffer && payload_hash_0.BYTES_PER_ELEMENT === 1 && payload_hash_0.length === 32)) {
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(grantee_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(level_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 2 } }]);
    return [];
