...
export class Contract {
      ...
      attest: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('attest',
                                     ...
                                     'attestation-vault.compact line 67 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      grantDisclosure: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('grantDisclosure',
                                     'argument 1 (as invoked from Typescript)',
                                     'attestation-vault.compact line 73 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(payload_hash_0.buffer instanceof ArrayBuffer && payload_hash_0.BYTES_PER_ELEMENT === 1 && payload_hash_0.length === 32)) {
      ...
      revokeDisclosure: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revokeDisclosure',
                                     'argument 1 (as invoked from Typescript)',
                                     'attestation-vault.compact line 86 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(payload_hash_0.buffer instanceof ArrayBuffer && payload_hash_0.BYTES_PER_ELEMENT === 1 && payload_hash_0.length === 32)) {
      ...
      commitValue: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('commitValue',
                                     'argument 1 (as invoked from Typescript)',
                                     'attestation-vault.compact line 94 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(payload_hash_0.buffer instanceof ArrayBuffer && payload_hash_0.BYTES_PER_ELEMENT === 1 && payload_hash_0.length === 32)) {
      ...
      provePredicate: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('provePredicate',
                                     'argument 1 (as invoked from Typescript)',
                                     'attestation-vault.compact line 104 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(payload_hash_0.buffer instanceof ArrayBuffer && payload_hash_0.BYTES_PER_ELEMENT === 1 && payload_hash_0.length === 32)) {
  ...
  _local_secret_key_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('local_secret_key',
                                 'return value',
                                 'attestation-vault.compact line 44 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _caller_id_0(context, partialProofData) {
    return this._persistentHash_0(this._local_secret_key_0(context,
                                                           partialProofData));
  }
  ...
  _provePredicate_0(context, partialProofData, payload_hash_0, threshold_0, op_0)
  {
    ...
    const claimKey_0 = this._persistentHash_1({ payload_hash: payload_hash_0,
    ...
    value_commitments: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'attestation-vault.compact line 31 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
