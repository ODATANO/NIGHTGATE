...
Wallet viewing keys are encrypted at rest. For production-like setups, set `ENCRYPTION_KEY` explicitly instead of relying on the process-scoped dev fallback.
